...
#define _Speed 3.8  //disk rotation speed

#define _Steps  6. //disk texture layers
#define _Size 0.45 //size of BH
...
vec4 background(vec3 ray)
{
    ...
    float brightness = value( uv*.5, 100.); //(poor quality) "stars" created from value noise
